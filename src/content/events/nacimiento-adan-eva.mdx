...
locations:
  - id: "eden"
    ...
    svgPosition: [620, 320]
characters:
  - { id: "adan", role: "protagonista", lore: "Es el primer ser humano. Dios le insufla aliento en la nariz y se convierte en alma viviente.", quote: "Esta es hueso de mis huesos y carne de mi carne." }
  - { id: "eva", role: "protagonista", lore: "Formada de la costilla de Adán según la Torá, o conjuntamente según interpretaciones del Corán. Compañera del primer hombre." }
  - { id: "lilith", role: "tradicion-rabinica", lore: "Ausente del relato canónico. Tradición rabínica medieval la sitúa como primera esposa de Adán, rebelde, creada del polvo igual que él." }
...
media:
  hero:
    src: "/images/events/primordial/nacimiento-adan-eva.jpg"
