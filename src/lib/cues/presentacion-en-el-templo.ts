...
const CUES: Cue[] = [
  ...
  // Sacrificio de tórtolas — paloma
  { match: /t[oó]rtolas|dos palominos|dos pichones|ofrenda de los pobres|sacrificio prescrito|purificaci[oó]n/i, cueId: 'fx:dove-flight', data: { from: [582, 363], to: [582, 358] } },
  // Polvo del atrio
  { match: /t[oó]rtolas|ofrenda.{0,12}templo|atrio del Templo|patio de las mujeres/i, cueId: 'fx:dust-burst', data: { position: [582, 363] } },
  ...
  // Nunc dimittis — halo sobre Simeón
  ...
  // Luz para las naciones — divine light beam
  { match: /luz para revelaci[oó]n.{0,12}gentiles|l[uú]z de las naciones|gloria de tu pueblo/i, cueId: 'fx:divine-light-beam', data: { position: [582, 360] } },
  ...
  // Rollo de la Ley — cumplimiento de la Torá
  { match: /prescrito en la Ley|seg[uú]n la Ley de Mois[eé]s|cumpliendo la Ley|lo que manda la Ley/i, cueId: 'fx:scroll-unfurl', data: { position: [582, 363] } },
];
