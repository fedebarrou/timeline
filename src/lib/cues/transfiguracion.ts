...
const CUES: Cue[] = [
  ...
  // Monte resplandeciente — figurativo de la teofanía
  { match: /monte alto|Tabor|Hermón|cima del monte|en el monte|monte santo/i, cueId: 'fx:mountain-glow', data: { position: [581, 352] } },
